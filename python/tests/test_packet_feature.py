...
ONE_PKT_PCAP = os.path.join('test_data','1_packet_tcp.pcapng')
GENERATED_ONE_PKT_CSV = os.path.join('test_data','temp_1_packet_tcp.csv')
ONE_PKT_CSV = os.path.join('test_data','1_packet_tcp.csv')
